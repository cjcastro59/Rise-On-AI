      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-5 bg-[#eef3f8]">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-dm-serif text-dark-text">97.3%</p>
        ...
        <Card className="p-5 bg-[#eef3f8]">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              <p className="text-xs text-dark-text/70 font-poppins">AVG PROCESS TIME</p>
              <p className="text-2xl font-dm-serif text-dark-text">142ms</p>
              <p className="text-xs text-dark-text/70 font-poppins">↑ Fast</p>
            </div>
          </div>
        ...
        <Card className="p-5 bg-[#eef3f8]">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-dm-serif text-dark-text">61%</p>
            </div>
          </div>
        ...
        <Card className="p-6 bg-[#eef3f8]">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-poppins text-dark-text">Very High (90-100%)</span>
              </div>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/70">68%</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-poppins text-dark-text">High (70-89%)</span>
              </div>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/70">29%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-poppins text-dark-text">Medium (60-69%)</span>
              </div>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/70">10.3%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-poppins text-dark-text">Low (&lt;60%)</span>
              </div>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/70">2.7%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="px-3 py-1 bg-[#A8DADC]/20 rounded-full text-xs font-semibold font-poppins text-dark-text">Tagalog 96.1%</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6 bg-[#eef3f8]">
          ...
          <div className="relative w-full h-48 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <p className="text-lg font-dm-serif text-dark-text">60%</p>
          ...
          <div className="grid grid-cols-2 gap-2 mt-4 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-poppins text-dark-text">Joy 42%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#A8DADC]"></div>
              <span className="text-xs font-poppins text-dark-text">Calm 18%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#FFE8A1]"></div>
              <span className="text-xs font-poppins text-dark-text">Anxiety 24%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#F4A6A6]"></div>
              <span className="text-xs font-poppins text-dark-text">Distress 7%</span>
            </div>
          </div>
        </Card>
      </div>

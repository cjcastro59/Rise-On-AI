    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center pb-4 border-b border-gray-200">
        <div>
          ...
          <p className="text-sm text-dark-text/60 font-poppins">Anonymous user satisfaction and platform feedback</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="stat-card border-l-4 border-l-[#FFE8A1]">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              <p className="text-xs text-dark-text/60 font-poppins">AVG PLATFORM RATING</p>
              <p className="text-2xl font-dm-serif text-dark-text">4.7</p>
              <p className="text-xs text-dark-text/60 font-poppins">out of 5.0</p>
            </div>
          </div>
        ...
        <Card className="stat-card border-l-4 border-l-success-green">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              <p className="text-xs text-dark-text/60 font-poppins">TOTAL RESPONSES</p>
        ...
        <Card className="stat-card border-l-4 border-l-primary-blue">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              <p className="text-xs text-dark-text/60 font-poppins">WOULD RECOMMEND</p>
        ...
        <Card className="stat-card border-l-4 border-l-lavender">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-right">
              <p className="text-xs text-dark-text/60 font-poppins">OPEN COMMENTS</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-xs font-poppins text-dark-text/60">RATING DISTRIBUTION</p>
        </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <p className="text-xs font-poppins text-dark-text">★★★★★ 5 Stars</p>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">52%</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">28%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">12%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">8%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">3%</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-xs font-poppins text-dark-text/60">FEATURES SATISFACTION SCORES</p>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <p className="text-sm font-poppins text-dark-text">AI Sentiment Analysis</p>
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">4.8/5</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">4.6/5</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-inter text-dark-text/60">4.9/5</p>
                <div className="w-40 h-2 bg-gray-100 rounded-full overflow-hidden">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs font-poppins text-dark-text/60">ANONYMIZED OPEN COMMENTS (SAMPLES)</p>
          </div>
        ...
        <div className="space-y-4">
          {mockFeedback.map((feedback) => (
            <div key={feedback.id} className={`p-4 rounded-xl border-l-4 ${
              feedback.type === "Positive" ? "border-success-green bg-success-green/10 border-success-green/20" :
              ...
              <div className="flex items-start gap-3 mb-2">
                <span className={`badge ${
                  feedback.type === "Positive" ? "badge-success" :
                  feedback.type === "Suggestion" ? "badge-info" :
                  "badge-warning"
                }`}>{feedback.type}</span>
                <span className="text-xs text-dark-text/60 font-inter ml-auto">{feedback.id} • {feedback.date}</span>
              </div>

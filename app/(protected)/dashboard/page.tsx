...
export default function DashboardPage() {
  ...
  return (
    <>
      ...
      <Card
        className="mb-8 px-6 py-4 bg-white border-l-4 transition-all"
        style={{ borderLeftColor: wellnessCfg?.borderColor ?? "#e5e7eb" }}
      >
        {wellnessLoading ? (
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <Link href="/journal">
              <Button size="sm" variant="outline" className="text-xs border-[#A8DADC] text-[#4EAAB3] hover:bg-[#A8DADC]/10 whitespace-nowrap">
                Start Journaling →
              </Button>
            </Link>
          </div>
